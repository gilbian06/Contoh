<?php
	...
	if(isset($_POST['bsimpan']))
	{
		...
		else
		{
			...
			$simpan = mysqli_query($koneksi, "INSERT INTO karyawan (nama, alamat, kelamin)
										  VALUES ( 
										  		 '$_POST[tnama]', 
										  		 '$_POST[talamat]', 
										  		 '$_POST[tkelamin]')
...
<div class="container">
	...
	<h1 class="text-center">DATABASE KARYAWAN</h1>
	  ...
	  <div class="card-body">
	    ...
	    <table class="table table-bordered table-striped">
	    	...
	    	<tr>
	    		...
	    		<td><?=$data['kelamin']?></td>
	    		<td>
	    			<a href="index.php?hal=edit&id=<?=$data['id_karyawan']?>" class="btn btn-warning"> Edit </a>
	    			<a href="index.php?hal=hapus&id=<?=$data['id_karyawan']?>" 
	...
	<!-- Akhir Card Tabel -->
	<a href="index.php" class="btn btn-warning">Data Karyawan</a>
		<a href="film.php" class="btn btn-warning">Data Film</a>
